# Generated by Django 4.2.7 on 2025-04-19 20:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='project',
            name='tags',
            field=models.ManyToManyField(blank=True, to='Main.projecttag', verbose_name='Project Tags'),
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
        ...
        migrations.AddConstraint(
            model_name='reference',
            constraint=models.CheckConstraint(check=models.Q(('article__isnull', False), ('book__isnull', False), ('thesis__isnull', False), _connector='OR'), name='reference_must_have_one_source'),
        ),
        ...
        migrations.AddConstraint(
            model_name='bookchapter',
            constraint=models.CheckConstraint(check=models.Q(('book__isnull', False), ('translated_book__isnull', False), _connector='OR'), name='chapter_must_belong_to_book_or_translated_book'),
        ),
        migrations.AlterUniqueTogether(
            name='articlereference',
