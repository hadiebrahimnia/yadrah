...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('section_type', models.CharField(choices=[('subject', 'Subject'), ('stimuli', 'Stimuli'), ('materials', 'Materials/Instruments'), ('procedure', 'Procedure'), ('data_acquisition', 'Data acquisition and analysis'), ('data_analysis', 'Data Analysis'), ('ethical_considerations', 'Ethical Considerations')], max_length=100, verbose_name='Section Type')),
                ('title', models.CharField(blank=True, max_length=200, verbose_name='Default Title')),
                ('description', models.TextField(blank=True, verbose_name='Description/Guidance')),
                ('required', models.BooleanField(default=True, verbose_name='Required Section')),
                ('default_position', models.PositiveIntegerField(default=0, verbose_name='Default Position')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('cited_content_type', models.ForeignKey(default='article', limit_choices_to={'model__in': ['article', 'book', 'thesis']}, on_delete=django.db.models.deletion.CASCADE, related_name='cited_references', to='contenttypes.contenttype')),
