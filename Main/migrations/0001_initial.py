...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('section_type', models.CharField(choices=[('title', 'Title Page'), ('abstract', 'Abstract'), ('introduction', 'Introduction'), ('problem_statement', 'Problem Statement'), ('research_questions', 'Research Questions'), ('objectives', 'Objectives'), ('significance', 'Significance of Research'), ('literature_review', 'Literature Review'), ('methodology', 'Methodology'), ('research_design', 'Research Design'), ('data_collection', 'Data Collection Methods'), ('data_analysis', 'Data Analysis Methods'), ('timeline', 'Timeline/Schedule'), ('budget', 'Budget'), ('expected_outcomes', 'Expected Outcomes'), ('references', 'References'), ('appendices', 'Appendices'), ('team', 'Research Team'), ('facilities', 'Facilities and Resources')], max_length=100, verbose_name='Section Type')),
                ('title', models.CharField(blank=True, max_length=200, verbose_name='Default Title')),
                ('description', models.TextField(blank=True, verbose_name='Description/Guidance')),
                ('required', models.BooleanField(default=True, verbose_name='Required Section')),
                ('default_position', models.PositiveIntegerField(default=0, verbose_name='Default Position')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('section_type', models.CharField(choices=[('title', 'Title Page'), ('approval', 'Approval Page'), ('dedication', 'Dedication'), ('acknowledgments', 'Acknowledgments'), ('abstract', 'Abstract'), ('table_of_contents', 'Table of Contents'), ('list_of_tables', 'List of Tables'), ('list_of_figures', 'List of Figures'), ('list_of_abbreviations', 'List of Abbreviations'), ('list_of_symbols', 'List of Symbols'), ('introduction', 'Introduction'), ('literature_review', 'Literature Review'), ('methodology', 'Methodology'), ('results', 'Results'), ('discussion', 'Discussion'), ('conclusion', 'Conclusion'), ('recommendations', 'Recommendations'), ('references', 'References'), ('appendices', 'Appendices'), ('cv', 'Curriculum Vitae')], max_length=100, verbose_name='Section Type')),
                ('title', models.CharField(blank=True, max_length=200, verbose_name='Default Title')),
                ('description', models.TextField(blank=True, verbose_name='Description/Guidance')),
                ('required', models.BooleanField(default=True, verbose_name='Required Section')),
                ('default_position', models.PositiveIntegerField(default=0, verbose_name='Default Position')),
        ...
        migrations.CreateModel(
            name='Article',
            fields=[
                ('project_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='Main.project')),
                ...
                ('aricale_status', models.CharField(choices=[('draft', 'Draft'), ('submitted', 'Submitted'), ('under_review', 'Under Review'), ('accepted', 'Accepted'), ('published', 'Published'), ('rejected', 'Rejected')], default='draft', max_length=50, verbose_name='Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_default', models.BooleanField(default=False, verbose_name='Default Template')),
                ('sections', models.ManyToManyField(related_name='templates', to='Main.researchprojecttemplatesection', verbose_name='Sections')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='book',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chapters', to='Main.book', verbose_name='Book'),
        ),
        migrations.CreateModel(
            name='BookAuthorship',
            fields=[
        ...
        migrations.AddField(
            ...
            name='publications',
            field=models.ManyToManyField(blank=True, to='Main.article', verbose_name='Related Publications'),
        ),
        migrations.AddField(
            model_name='researchproject',
            name='research_team',
            field=models.ManyToManyField(blank=True, related_name='team_projects', to='Main.author', verbose_name='Research Team'),
        ),
        migrations.AddField(
            model_name='researchproject',
            name='supervisor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='supervised_projects', to='Main.author', verbose_name='Supervisor'),
        ),
        migrations.AddField(
            model_name='researchproject',
            name='template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Main.researchprojecttemplate', verbose_name='Project Template'),
        ),
        migrations.CreateModel(
            name='Milestone',
            fields=[
                ...
                ('deliverables', models.TextField(blank=True, verbose_name='Deliverables')),
                ('order', models.PositiveIntegerField(default=0, verbose_name='Order')),
                ('research_project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='milestones', to='Main.researchproject', verbose_name='Research Project')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='collaborated_proposals', to='Main.author', verbose_name='Co-Investigators'),
        ),
        migrations.AddField(
            model_name='researchproposal',
            name='principal_investigator',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='led_proposals', to='Main.author', verbose_name='Principal Investigator'),
        ),
        migrations.AddField(
            model_name='researchproposal',
            name='template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Main.researchproposaltemplate', verbose_name='Proposal Template'),
        ),
        migrations.CreateModel(
            name='ThesisSection',
            fields=[
        ...
        migrations.AddField(
            model_name='thesis',
            name='advisor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='advised_theses', to='Main.author', verbose_name='Advisor'),
        ),
        migrations.AddField(
            model_name='thesis',
            name='committee',
            field=models.ManyToManyField(blank=True, related_name='committee_theses', to='Main.author', verbose_name='Committee Members'),
        ),
        migrations.AddField(
            model_name='thesis',
            name='keywords',
            field=models.ManyToManyField(blank=True, related_name='theses', to='Main.keyword', verbose_name='Keywords'),
        ),
        migrations.AddField(
            model_name='thesis',
            name='supervisor',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='supervised_theses', to='Main.author', verbose_name='Supervisor'),
        ),
        migrations.AddField(
            model_name='thesis',
            name='template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Main.thesistemplate', verbose_name='Thesis Template'),
        ),
        migrations.CreateModel(
